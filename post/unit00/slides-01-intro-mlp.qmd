...
# Part 1: Linear Models {background-color="#1e3a5f" style="color:white;"}
...
# Part 2: Gradient Descent {background-color="#1e3a5f" style="color:white;"}
...
# Part 3: The ML Framework {background-color="#1e3a5f" style="color:white;"}
...
# Part 4: Neural Networks {background-color="#1e3a5f" style="color:white;"}
...
# Part 5: From Playground to PyTorch {background-color="#1e3a5f" style="color:white;"}
...
# Part 6: Wrap-Up {background-color="#1e3a5f" style="color:white;"}
...
| Week 3b | Hyperparameter tuning | `notebook-06-tf-binding-wandb` |
