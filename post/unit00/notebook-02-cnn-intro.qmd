...
[Jupyter notebook in Colab](#) *(link coming)*
...
We split the 2000 samples into train (72%), validation (8%), and test (20%) sets, then convert the NumPy arrays to PyTorch tensors and move them to the device.
...
> **Discuss:** Train and validation loss should decrease together — divergence means overfitting.
...
> **Discuss:** Final accuracy on the held-out test set — data the model never saw during training.
